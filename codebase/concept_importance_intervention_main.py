...
def intervene_Baselines(args, model_type):
    args.json_file = os.path.join(args.base_path, "codebase", "Completeness_and_interventions", "paths_MoIE.json")
    alt_preds, test_tensor_y, test_tensor_preds = perform_interventions(args)
    return compute_acc_and_save(alt_preds, test_tensor_y, test_tensor_preds, model_type=model_type)
...
if __name__ == "__main__":
    ...
    for top_k in args.top_K:
        ...
        if args.model == "MoIE":
            ...
            acc, save_path = intervene_Baselines(args, model_type="Baseline")
        elif args.model == "Baseline_PCBM_logic":
            acc, save_path = intervene_Baselines(args, model_type="Baseline_PostHoc")
