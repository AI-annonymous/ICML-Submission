...
def predict_t_p(
    ...
    attributes_train = torch.load(
        "root-path/out/spurious-cub/cub/t/lr_0.001_epochs_95_ResNet101_layer4_adaptive_sgd_BCE/dataset_g/train_proba_concepts.pt")
    attribute_val = torch.load(
        "root-path/out/spurious-cub/cub/t/lr_0.001_epochs_95_ResNet101_layer4_adaptive_sgd_BCE/dataset_g/test_proba_concepts.pt")
...
def get_bb(args, chk_pt_path_bb, device):
    if (args.arch == "ResNet50" or args.arch == "ResNet101" or args.arch == "ResNet152") and args.projected == "n":
        ...
        chkpt = os.path.join(
            "root-path/checkpoints/spurious-cub-specific-classes/cub/explainer/ViT-B_16/lr_0.01_epochs_500_temperature-lens_6.0_use-concepts-as-pi-input_True_input-size-pi_2048_cov_0.95_alpha_0.5_selection-threshold_0.5_lambda-lens_0.0001_alpha-KD_0.99_temperature-KD_10.0_hidden-layers_1_layer_VIT_explainer_init_none/iter1/explainer_projected",
