#!/bin/sh
#SBATCH --output=path/cub_vit_%j.out
pwd; hostname; date
CURRENT=`date +"%Y-%m-%d_%T"`
echo $CURRENT

slurm_output_bb_train=cub_vit_bb_train_$CURRENT.out
slurm_output_bb_test=cub_vit_bb_test_$CURRENT.out
slurm_output_t_train=cub_vit_t_train_$CURRENT.out
slurm_output_t_test=cub_vit_t_test_$CURRENT.out
slurm_output_iter1_g_train=cub_vit_iter1_g_train_$CURRENT.out
slurm_output_iter1_g_test=cub_vit_iter1_g_test_$CURRENT.out
slurm_output_iter1_residual_train=cub_vit_iter1_residual_train_$CURRENT.out
slurm_output_iter2_g_train=cub_vit_iter2_g_train_$CURRENT.out
slurm_output_iter2_g_test=cub_vit_iter2_g_test_$CURRENT.out
slurm_output_iter2_residual_train=cub_vit_iter2_residual_train_$CURRENT.out
slurm_output_iter3_g_train=cub_vit_iter3_g_train_$CURRENT.out
slurm_output_iter3_g_test=cub_vit_iter3_g_test_$CURRENT.out
slurm_output_iter3_residual_train=cub_vit_iter3_residual_train_$CURRENT.out
slurm_output_iter4_g_train=cub_vit_iter4_g_train_$CURRENT.out
slurm_output_iter4_g_test=cub_vit_iter4_g_test_$CURRENT.out
slurm_output_iter4_residual_train=cub_vit_iter4_residual_train_$CURRENT.out
slurm_output_iter5_g_train=cub_vit_iter5_g_train_$CURRENT.out
slurm_output_iter5_g_test=cub_vit_iter5_g_test_$CURRENT.out
slurm_output_iter5_residual_train=cub_vit_iter5_residual_train_$CURRENT.out
slurm_output_iter6_g_train=cub_vit_iter6_g_train_$CURRENT.out
slurm_output_iter6_g_test=cub_vit_iter6_g_test_$CURRENT.out
slurm_output_iter6_residual_train=cub_vit_iter6_residual_train_$CURRENT.out
slurm_output_iter6_residual_test=cub_vit_iter6_residual_test_$CURRENT.out

echo "CUB-200 VIT-B_16"
...
python ./codebase/BB/VIT/TransFG-master/train_CUB.py --seed 42 --bs 16 --name "VIT_CUBS" --learning_rate 0.03 --arch "ViT-B_16" --eval_every 10 --lr 0.03 --weight-decay 0 --num_steps 10000 --decay_type "cosine" --warmup_steps 500 --max_grad_norm 1.0 --seed 42 --gradient_accumulation_steps 1 --split non-overlap > $slurm_output_bb_train
...
# T model 
# train
python ./codebase/train_t_CUB.py --checkpoint-file "bb_chkpt.pth.tar" --bs 32 --layer "VIT" --flattening-type "VIT" --arch "VIT-B_16" > $slurm_output_t_train

# Test
python ./codebase/test_t_CUB.py --checkpoint-file "bb_chkpt.pth.tar" --checkpoint-file-t "t_chkpt.pth.tar" --save-concepts True --bs 16 --solver-LR "sgd" --loss-LR "BCE" --layer "VIT" --flattening-type "VIT" --arch "VIT-B_16"> $slurm_output_t_test
